...
public class searchAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            holder.AvgRate = (TextView) view.findViewById(R.id.SearchName);
            holder.Name = (TextView) view.findViewById(R.id.SearchDp);
            holder.UserName = (TextView) view.findViewById(R.id.SearchRating);
            holder.picture = (ImageView) view.findViewById(R.id.HCaption);
