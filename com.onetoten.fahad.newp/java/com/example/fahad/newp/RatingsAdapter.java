...
public class RatingsAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            holder.rating = (TextView) view.findViewById(R.id.action_id);
            holder.name = (TextView) view.findViewById(R.id.ratingsss);
            holder.CreatedAt = (TextView) view.findViewById(R.id.rName);
