...
public class ProfileAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = this.inflater.inflate(R.layout.profile_post, null);
            holder.AvgRate = (TextView) view.findViewById(R.id.PLSrating);
            holder.Caption = (TextView) view.findViewById(R.id.Pcaption);
            holder.CreatedAt = (TextView) view.findViewById(R.id.PcreatedAt);
            ...
            public boolean onLongClick(View v) {
                ...
                new Builder(ProfileAdapter.this.context).setTitle("Delete entry").setMessage("Are you sure you want to delete this picture...CHICKEN? :p").setPositiveButton(17039379, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        String SchoolClass = u.get("SchoolClass").toString();
                        String picId = ((ProfilePost) ProfileAdapter.this.post1.get(position)).getPicObjectId();
                        ParseQuery<ParseObject> query1 = ParseQuery.getQuery(SchoolClass);
