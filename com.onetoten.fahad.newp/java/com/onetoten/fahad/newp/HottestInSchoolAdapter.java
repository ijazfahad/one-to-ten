...
public class HottestInSchoolAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = this.inflater.inflate(R.layout.hottest_single_item, null);
            holder.AvgRate = (TextView) view.findViewById(R.id.hotProRating);
            holder.Name = (TextView) view.findViewById(R.id.hotName);
            holder.UserName = (TextView) view.findViewById(R.id.hotUserName);
            holder.picture = (ImageView) view.findViewById(R.id.HoimageView);
