...
public class ListViewAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = this.inflater.inflate(R.layout.single_post, null);
            holder.Name = (TextView) view.findViewById(R.id.sFname);
            holder.Caption = (TextView) view.findViewById(R.id.HCaption);
            holder.CreatedAt = (TextView) view.findViewById(R.id.HCreatedAt);
            holder.AvgRating = (TextView) view.findViewById(R.id.hAvgRating);
            holder.picture = (ImageView) view.findViewById(R.id.Rimage);
            holder.Ppicture = (ImageView) view.findViewById(R.id.dpPicture);
            view.setTag(holder);
        } else {
